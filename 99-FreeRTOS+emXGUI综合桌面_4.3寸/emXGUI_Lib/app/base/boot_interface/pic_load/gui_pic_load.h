...
typedef enum
{
	...
	hdc_clock_end,              // Õâ¸ö±ØÐë·ÅÔÚ×îºó
}hdc_clock_png_t;
...
#define GUI_ADC_SLIDER_BTN_PIC    "0:/slider_button.png"    // 53 * 53
#define GUI_ADC_SLIDER_PIC        "0:/slider.png"           // 360 * 27 
