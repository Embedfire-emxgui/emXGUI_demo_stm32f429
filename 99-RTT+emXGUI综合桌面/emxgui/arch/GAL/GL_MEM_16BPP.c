...
/**
  ...
  * @retval 坐标在绘图表面对应的地址
  */
void* 	GL16_set_addr(const SURFACE *pSurf,int x,int y)
{
...
void	GL16_xor_pixel(const SURFACE *pSurf,int x,int y)
{
	COLOR16 *addr;
...
void	GL16_draw_vline(const SURFACE *pSurf,int x0,int y0,int y1,COLORREF c)
{
	COLOR16 *addr;
	
	addr = __set_addr(pSurf,x0,y0);
	GUI_memset16_step(addr,c,y1-y0,pSurf->WidthBytes>>1);		
}

/*=========================================================================================*/

void	GL16_fill_rect(const SURFACE *pSurf,int x,int y,int w,int h,COLORREF c)
{
	COLOR16 *addr;
	int line_step;
...
int GL16_copy_bits(const SURFACE *pSurf,int x,int y,int w,int h,int width_bytes,U8 *dst_bits)
{
	int yy;
	U8 *src_bits;
	////
...
void GL16_draw_bitmap_LUT1(const SURFACE *pSurf,int x,int y,int w,int h,int width_bytes, const U8 *bits,int bit_offset,const COLORREF *LUT)
{
	int xx,yy;
	U8 *p,dat;
	COLOR16 color0,color1,*addr;
	////
...
void 	GL16_draw_bitmap_LUT2(const SURFACE *pSurf,int x,int y,int w,int h,int width_bytes,const U8 *bits,int bit_offset,const COLORREF *LUT)
{

}

void 	GL16_draw_bitmap_LUT4(const SURFACE *pSurf,int x,int y,int w,int h,int width_bytes,const U8 *bits,int bit_offset,const COLORREF *LUT)
{
	int xx,yy;
	U8 *p,dat;
	COLOR16 *addr;
...
void 	GL16_draw_bitmap_LUT8(const SURFACE *pSurf,int x,int y,int w,int h,int width_bytes,const U8 *bits,const COLORREF *LUT)
{
	int xx,yy;
	U8 *p;
	COLOR16 *addr;
...
void 	GL16_draw_bitmap_RGB332(const SURFACE *pSurf,int x,int y,int w,int h,int width_bytes,const U8 *bits)
{
	int xx,yy;
	U8 *p,color;
	COLOR16 *addr;
...
void 	GL16_draw_bitmap_RGB565(const SURFACE *pSurf,int x,int y,int w,int h,int width_bytes,const U8 *bits)
{
...
void 	GL16_draw_bitmap_XRGB1555(const SURFACE *pSurf,int x,int y,int w,int h,int width_bytes,const U8 *bits)
{
	int xx,yy;
	U16 *p,color;
	COLOR16 *addr;
...
void 	GL16_draw_bitmap_ARGB1555(const SURFACE *pSurf,int x,int y,int w,int h,int width_bytes,const U8 *bits)
{
	int xx,yy;
	U16 *p,color;
	COLOR16 *addr;
...
void 	GL16_draw_bitmap_ARGB4444(const SURFACE *pSurf,int x,int y,int w,int h,int width_bytes,const U8 *bits)
{
	U16 *p,color;
  	U8 r,g,b,a;
	U8 r0,g0,b0,a0;
				...
				default:
						{
							...
							if(pSurf->Format == SURF_ARGB4444)
							{
								...
								*addr++ =ARGB4444(a0>>4,r0>>4,g0>>4,b0>>4);
...
void 	GL16_draw_bitmap_RGB888(const SURFACE *pSurf,int x,int y,int w,int h,int width_bytes,const U8 *bits)
{
	U8 r,g,b;
	int xx,yy;
	int i;
...
void 	GL16_draw_bitmap_XRGB8888(const SURFACE *pSurf,int x,int y,int w,int h,int width_bytes,const U8 *bits)
{
	U8 r,g,b;
	int xx,yy;
	int i;
...
void 	GL16_draw_bitmap_ARGB8888(const SURFACE *pSurf,int x,int y,int w,int h,int width_bytes,const U8 *bits)
{
	U8 r,g,b,a;
	U8 r0,g0,b0,a0;
	int xx,yy;
...
void 	GL16_draw_bitmap_AL1(const SURFACE *pSurf,int x,int y,int w,int h,int width_bytes, const U8 *bits,int bit_offset,COLORREF color)
{
	int xx,yy;
	U8 *p,dat;
	COLOR16 *addr;
...
void GL16_draw_bitmap_AL2(const SURFACE *pSurf,int x,int y,int w,int h,int width_bytes,const U8 *bits,int bit_offset,COLORREF color)
{
	COLOR16 *addr;
	int i,xx;
	U8 r,g,b,a,aa;
...
void GL16_draw_bitmap_AL4(const SURFACE *pSurf,int x,int y,int w,int h,int width_bytes,const U8 *bits,int bit_offset,COLORREF color)
{
	COLOR16 *addr;
	int i,xx;
	U8 r,g,b,a,aa;
...
void GL16_draw_bitmap_AL8(const SURFACE *pSurf,int x,int y,int w,int h,int width_bytes,const U8 *bits,COLORREF color)
{
	COLOR16 *addr;
	int xx;
	U8 r,g,b,a;
...
BOOL 	GL16_scale_bitmap(const SURFACE *pSurf,int x,int y,int w,int h,const BITMAP *bm)
{
...
//	src_y = src_y<<16;
	...
	dst_p = (U16*)__set_addr(pSurf,x,y);
...
BOOL	GL16_rotate_bitmap(const SURFACE *pSurf,int cx,int cy,const BITMAP *bm,int angle)
{
	//float radians; 
	int cos_a,sin_a; 
	int minx,miny;
	...
	{ 
		...
		{ 
			...
			case BM_RGB565:
				bits += (xx1<<1);
				GL16_draw_bitmap_RGB565(pSurf,xx0,yy0,1,1,bm->WidthBytes,bits);
				break;
			case BM_ARGB4444:
				bits += (xx1<<1);
				GL16_draw_bitmap_ARGB4444(pSurf,xx0,yy0,1,1,bm->WidthBytes,bits);
				break;
			case BM_ARGB8888:
				bits += (xx1<<2);
				GL16_draw_bitmap_ARGB8888(pSurf,xx0,yy0,1,1,bm->WidthBytes,bits);
				break;
			default:
				return FALSE;
